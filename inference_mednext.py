'''
The script is identical to the one provided from the Challenge "inference.py" from the https://github.com/RiqiangGao/GDP-HMM_AAPMChallenge/blob/main/inference.py
The only difference is that the data_loader_efficient.py is used to load the data
'''
